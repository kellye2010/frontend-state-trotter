...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onShowItem = function onShowItem(element, code, region) {
	  event.preventDefault();
	  var item = getFormFields(event.target).item;
	  api.showItem(item.id).then(ui.showItemSuccess).then(function (data) {
